...
class PartialPivoting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Partial Pivoting Results'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              'm21 = ${valuesChanged ? m31.toString() : m21.toString()}',
                              style: const TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 20),
                            ...
                            Text(
                              'm31 = ${valuesChanged ? m21.toString() : m31.toString()}',
                              style: const TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 20),
  ...
  void calculateGE() {
    if (matrixInfo[1][0].abs() > matrixInfo[0][0].abs() &&
        matrixInfo[2][0].abs() > matrixInfo[0][0].abs()) {
